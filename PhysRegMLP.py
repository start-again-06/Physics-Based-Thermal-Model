...
from utils.support_functions import transform_temp, inverse_transform_temp, inverse_transform_action, inverse_transform_outside_temp
from utils.support_functions import fc_module


class PhysRegMLP(pl.LightningModule):
